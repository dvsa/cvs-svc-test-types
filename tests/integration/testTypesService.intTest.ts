  ...
  describe("getTestTypes", () => {
    ...
    context("when database is populated", () => {
      context("GET /test-types", () => {
        ...
        it("should return only testTypes for VTM where applicableTo is vtm", async () => {
        ...
        it("should return only testTypes for VTA where applicableTo is not provided", async () => {
