...
describe("getTestTypesById", () => {
      ...
      return LambdaTester(getTestTypesById)
        ...
        .expectResolve((result: { statusCode: any; body: any }) => {
          ...
          expect(result.body).toEqual(
            '"Query parameter \\"vehicleSize\\" must be one of [small, large]"'
          );
        });
    });
  });
    ...
    it("should return 400", () => {
      return LambdaTester(getTestTypesById)
        ...
        .expectResolve((result: { statusCode: any; body: any }) => {
          expect(result.statusCode).toEqual(400);
          expect(result.body).toEqual(
            '"Query parameter \\"vehicleAxles\\" must be less than or equal to 99"'
          );
        });
    });
  });
  ...
  context(
    "when the queryStringParameter vehicleAxles is out of range from below",
    () => {
      it("should return 400", () => {
        return LambdaTester(getTestTypesById)
          .event({
  ...
  context("when the queryStringParameter vehicleSubclass is a string", () => {
  ...
  context(
    "when the queryStringParameter vehicleAxles is sent null as String",
    () => {
      it("should return 200", () => {
        const expectedResult = {
          id: "48",
  ...
  context(
    "when the queryStringParameter vehicleConfiguration is sent null as String",
    () => {
      it("should return 200", () => {
        const expectedResult = {
          id: "48",
  ...
  context("when the request is valid", () => {
      ...
      it("should return 200", () => {
        return LambdaTester(getTestTypesById)
          ...
          .expectResolve((result: { statusCode: any; body: string }) => {
            ...
            expect(JSON.parse(result.body).testTypeClassification).toEqual(
    ...
    context(
      "when searching for tests defined for vehicles with 5+ axles",
      () => {
        it("should return the correct test (200) for a vehicle with 5+ axles", () => {
          ...
          return LambdaTester(getTestTypesById)
            .event({
              queryStringParameters: {
                fields:
                  "testTypeClassification, defaultTestCode, linkedTestCode",
                vehicleType: "hgv",
                vehicleSize: "large",
                vehicleConfiguration: null,
                vehicleAxles: 7,
